  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden relative bg-[#e0f2fe] text-gray-900 font-sans">
      ...
      <motion.footer
        ...
        className="relative z-10 border-t border-sky-200 flex-shrink-0"
        style={{
        ...
        <div className="flex items-center justify-between w-full">
            ...
            {CATEGORIES.map((cat) => (
              <div key={cat.id} className="flex items-center gap-1.5">
                <div
                  ...
                  style={{ width: "8px", height: "8px", background: cat.color, flexShrink: 0 }}
                />
                <span
          ...
          <div className="flex items-center gap-5">
            {[
              ...
              >
                <span
                  className="font-black text-[#0ea5e9] leading-none"
                ...
                <span
                  ...
                  style={{ fontSize: "clamp(0.52rem, 0.75vw, 0.7rem)" }}
                >
                  {s.label}
                </span>
              </motion.div>
