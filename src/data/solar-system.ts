...
export const SOLAR_SYSTEM: Planet[] = [
  ...
  },
  {
    ...
    moons: [
      { id: "moon", name: "Bulan", emoji: "🌕", planet: "earth", fact: "Satu-satunya bulan alami Bumi" },
    ],
  ...
  },
  {
    ...
    moons: [
      { id: "phobos", name: "Phobos", emoji: "🪨", planet: "mars", fact: "Bulan terbesar Mars" },
      { id: "deimos", name: "Deimos", emoji: "🪨", planet: "mars", fact: "Bulan terkecil Mars" },
    ],
  ...
  },
  {
    ...
    moons: [
      { id: "titan", name: "Titan", emoji: "🌕", planet: "saturn", fact: "Bulan dengan atmosfer tebal seperti Bumi" },
  ...
  },
  {
    ...
    moons: [
      { id: "triton", name: "Triton", emoji: "🌑", planet: "neptune", fact: "Bergerak berlawanan arah orbit Neptunus" },
    ],
